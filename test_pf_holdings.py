# -*- coding: utf-8 -*-
"""ทดสอบออฟไลน์: pf_holdings.py — รันด้วย python3 test_pf_holdings.py"""
...
check("pf_version_bumped", PF.VERSION == "1.3")
check("pf_module_renamed", PF.__file__.endswith("pf_holdings.py"))
